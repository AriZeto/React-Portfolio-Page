  ...
  return (
    <svg width="1em" height="1em" viewBox="0 0 32 32" fill="none" {...props}>
      ...
      <defs id="prefix__defs50">
        ...
        >
          <stop stopColor="#41D1FF" id="prefix__stop38" />
          <stop offset={1} stopColor="#BD34FE" id="prefix__stop40" />
        </linearGradient>
        <linearGradient
          ...
          gradientTransform="translate(1.34 1.894) scale(.07142)"
        >
          <stop stopColor="#FFEA83" id="prefix__stop43" />
          <stop offset={0.083} stopColor="#FFDD35" id="prefix__stop45" />
          <stop offset={1} stopColor="#FFA800" id="prefix__stop47" />
        </linearGradient>
      </defs>
    </svg>
  );
...
const MemoViteSvg = React.memo(ViteSvg);
export default MemoViteSvg;
